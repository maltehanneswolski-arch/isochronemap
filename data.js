...
window.ISO = (function () {
  ...
  const COUNTRY_RAW = [
    ...
    ['Fr. S. Antarctic Lands', 20, 0, 9999, 9999], ['France', 105, .95, 1837, 1981], ['Gabon', 60, .20, 1986, 9999],
    ['Gambia', 53, 0, 9999, 9999], ['Georgia', 64, .40, 1872, 9999], ['Germany', 97, .95, 1835, 1991],
  ...
  const PALETTES = [
    { id: 'passage', name: 'Passage — full spectrum', ramp: [
    ...
    { id: 'galton', name: 'Galton 1881 — lithograph', ramp: [
    ...
    { id: 'fathom', name: 'Fathom — cool', ramp: [
    ...
    { id: 'ordnance', name: 'Ordnance — earth', ramp: [
